	...
	public ProcessingLoader(final iVisualElement root) {
		...
		if (appletShouldBeFullscreen == 0) {
			...
			((JFrame) frame).addWindowStateListener(new WindowStateListener() {
				...
				public void windowStateChanged(WindowEvent arg0) {
					...
					if (ns == WindowEvent.WINDOW_CLOSING) {
						System.out.println(" tried to close processing window ");
					}
				}
			});
			...
			frame.addComponentListener(new ComponentAdapter() {
				...
				public void componentResized(ComponentEvent e) {
					System.out.println(" resized frame ");
					drawQueue.new Task() {
						@Override
						protected void run() {
							applet.background(0);
		...
		applet = new PApplet() {
				...
				try {
					...
					try {
						if (drawQueue.getNumTasks() > 0)
							System.out.println(" draw has <" + drawQueue.getNumTasks() + "> tasks");
			...
			public void keyPressed() {
				...
				System.out.println(" key pressed in papplet");
			...
			public void setup() {
				...
				System.out.println(" setup called  <"+firstRun+"> <"+appletShouldBeFullscreen+">");
...
//					doHints();
			...
			public void setSize(int width, int height) {
				...
				System.out.println(" --ss1 <" + width + "> <" + height + ">");
			...
			public void setSize(Dimension d) {
				...
				System.out.println(" --ss2 <" + width + "> <" + height + ">");
				super.setSize(d);
			}
			...
			public void size(int iwidth, int iheight, String irenderer, String ipath) {
				...
				synchronized (Launcher.lock) {
					...
					System.out.println(" size <" + iwidth + "> <" + iheight + "> <" + irenderer + "> <" + ipath + ">");
			...
			protected void checkKeyEvent(KeyEvent e) {
				System.out.println(" check key pressed in papplet <" + e + ">");
		...
		if (Platform.isMac()) {
//			try {
//				Class c = this.getClass().getClassLoader().loadClass("quicktime.QTSession");
...
//			}
		...
		if (appletShouldBeFullscreen > 0) {
			...
			System.out.println(" bounds are <" + fullscreenbounds + ">");
