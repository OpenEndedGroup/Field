 ...
 * 
 */
public class TwoPassImageProcessingTwoOutput implements iImageProcessor {

	private ImageProcessingTwoOutput left;

	private ImageProcessingTwoOutput right;
	...
	public TwoPassImageProcessingTwoOutput(iProvider<Integer>[] fboInputs, int width, int height, final boolean useRect, boolean genMipmap, boolean useFloat, boolean doBothPasses) {
