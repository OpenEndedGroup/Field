...
public class HorizontalBottomToBottomAlign extends VerticalLeftToLeftAlign {

	static public class Resize extends HorizontalBottomToBottomAlign {
	...
	public HorizontalBottomToBottomAlign(float baseScore) {
		super(baseScore);
	}
	...
	@Override
	protected Class<? extends DefaultOverride> getConstraintClass() {
			return HorizontalBottomToBottomConstraint.class;
	}
