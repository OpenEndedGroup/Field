 ...
 * 
 * <p>
 * NanoHTTPD version 1.1, Copyright &copySource; 2001,2005-2007 Jarno Elonen
	...
	private class HTTPSession implements Runnable {
		...
		public void run() {
			try {
				...
				// version,
				// followed by HTTP headers. Ignore version but
				// parse headers.
				// NOTE: this now forces header names uppercase
				// since they are
				...
				System.out.println(" about to serve()");
				...
				// Thrown by sendError, ignore and exit the
				// thread.
			}
		}
