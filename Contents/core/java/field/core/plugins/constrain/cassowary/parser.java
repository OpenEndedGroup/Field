	protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\033\000\012\003\007\004\003\005\005\006\011\001" + "\001\000\002\001\001\000\002\001\001\000\002\001\001" + "\000\004\006\034\001\001\000\002\001\001\000\004\006" + "\031\001\001\000\002\001\001\000\002\001\001\000\004" + "\006\030\001\001\000\004\006\027\001\001\000\004\006"
	+ "\026\001\001\000\004\006\025\001\001\000\004\006\024" + "\001\001\000\004\006\023\001\001\000\004\006\022\001" + "\001\000\002\001\001\000\002\001\001\000\002\001\001" + "\000\002\001\001\000\002\001\001\000\002\001\001\000" + "\002\001\001\000\002\001\001\000\002\001\001\000\002" + "\001\001\000\002\001\001" });
	...
	public java.util.Hashtable<String, ClVariable> m_variable_name_object_hash;
...
class CUP$parser$actions {
	...
	public final Symbol CUP$parser$do_action(int CUP$parser$act_num, lr_parser CUP$parser$parser, java.util.Stack CUP$parser$stack, int CUP$parser$top) throws java.lang.Exception {
		...
		case 13: // expr ::= LPAREN expr RPAREN 
		{
			...
			Object a = ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).value;
			RESULT = a;
			CUP$parser$result = new Symbol(4/*expr*/, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right, RESULT);
		}
		...
		case 12: // expr ::= MINUS expr 
		{
			...
			Object a = ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).value;
			RESULT = (CL.Times(-1, (ClLinearExpression) a));
			CUP$parser$result = new Symbol(4/*expr*/, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).left, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right, RESULT);
		}
			return CUP$parser$result;
			/*. . . . . . . . . . . . . . . . . . . .*/
		case 11: // expr ::= expr DIVIDE expr 
		{
			...
			Object a = ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).value;
			...
			Object b = ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).value;
		...
		case 5: // inequality ::= expr LEQ expr 
		{
			...
			CUP$parser$result = new Symbol(3/*inequality*/, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right, RESULT);
		}
			return CUP$parser$result;
			/*. . . . . . . . . . . . . . . . . . . .*/
		...
		case 3: // equation ::= expr EQ expr 
		{
			...
			CUP$parser$result = new Symbol(2/*equation*/, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right, RESULT);
		}
			return CUP$parser$result;
			/*. . . . . . . . . . . . . . . . . . . .*/
		case 2: // constraint ::= inequality 
		{
			...
			Object a = ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).value;
			RESULT = a;
			CUP$parser$result = new Symbol(1/*constraint*/, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).left, ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right, RESULT);
		}
			return CUP$parser$result;
			/*. . . . . . . . . . . . . . . . . . . .*/
