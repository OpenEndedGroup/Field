...
public class ClTests extends CL {
	...
	public final static boolean multiedit() throws ExCLInternalError, ExCLRequiredFailure, ExCLError {
		try {
			boolean fOkResult = true;
			ClVariable x = new ClVariable("x");
			ClVariable y = new ClVariable("y");
	...
	public final static boolean inconsistent3() throws ExCLInternalError, ExCLRequiredFailure {
		try {
			...
			ClSimplexSolver solver = new ClSimplexSolver();
			solver	.addConstraint(new ClLinearInequality(w, CL.GEQ, 10.0))
	...
	public final static void main(String[] args) throws ExCLInternalError, ExCLNonlinearExpression, ExCLRequiredFailure, ExCLConstraintNotFound, ExCLError {
		//    try 
		{
