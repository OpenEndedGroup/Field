...
public class CocoaUIEnhancer {
    ...
    private static class MenuHookObject {
        ...
        public MenuHookObject( iUpdateable about, iUpdateable pref ) {
            this.about = about;
            this.pref = pref;
        }
     ...
     */
    public void hookApplicationMenu( Display display, iUpdateable aboutAction,
		    iUpdateable preferencesAction ) {
